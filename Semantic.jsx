   ...
   <div id="foreground">
        <div id="introSection">
            ...
            <div id="introText">
                ...
                <p>Developed a semantic search application capable of extracting and analyzing text from PDF documents. The application parses text from a PDF file, tokenizes it, and generates embeddings using the MiniLM-V6 model.</p>
